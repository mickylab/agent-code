...
# Dangerous command patterns — these patterns are always denied
...
# Read-only tools — these tools are always allowed, no confirmation needed
...
# Should let user know model uses this tools
